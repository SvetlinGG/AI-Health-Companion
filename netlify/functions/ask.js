exports.handler = async (event, context) => {
  ...
  try {
    ...
    const medicalResponses = {
      // English keywords
      'cancer': 'Based on your inquiry about cancer, I can provide you with some important medical information. Cancer represents a complex group of diseases characterized by uncontrolled cellular growth and potential metastasis. The most prevalent forms include breast, lung, colorectal, and prostate cancers.\n\nEarly detection significantly improves treatment outcomes, which is why I strongly recommend adhering to screening guidelines appropriate for your age and risk factors. Treatment approaches vary considerably depending on the type, stage, and individual patient factors, often involving surgery, chemotherapy, radiation therapy, or targeted therapies.\n\nI would advise scheduling a consultation with an oncologist if you have specific concerns or symptoms. They can provide personalized risk assessment and appropriate screening recommendations.',
